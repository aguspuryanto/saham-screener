...
import { AiRecommendation, AiScores } from '../../../domain/models/AiEngine';
...
function recommendationBadgeVariant(rec: AiRecommendation): 'success' | 'warning' | 'neutral' | 'danger' {
  switch (rec) {
    case 'BUY':
      return 'success';
    case 'WATCHLIST':
...
function scoreBarColor(score: number, invert: boolean): string {
